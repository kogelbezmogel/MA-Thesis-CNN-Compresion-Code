...
if __name__ == '__main__':
    ...
    max_reduction = 1.0
    algorithm_folder_path = '/net/people/plgrid/plgkogel/scratch/results/alexnet/IndirectDirect_wo_steps'
    ...
    for ratio in ratios:
        ...
        for attempt in attempts:
            ...
            if general_flops_ratio == None:
                ...
                ratio_path = os.path.join(algorithm_folder_path, f'AlexNet_rat_{int(100 - general_flops_ratio*100):02d}')
