...
if __name__ == '__main__':
    ...
    goal_flops_ratios = [0.66]
    
    retrain_epochs = 0
    last_retrain_epochs = 0
    n = 64
    algorithm_folder_path = '/net/people/plgrid/plgkogel/scratch/results/alexnet/MeanGradient_test'
