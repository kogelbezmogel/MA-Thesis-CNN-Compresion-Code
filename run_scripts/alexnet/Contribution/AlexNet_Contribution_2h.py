...
if __name__ == '__main__':
    ...
    hierarchical_groups = ls.get_hierarchical_groups_alexnet_2h_v2_contr()
    static_group = []
    ...
    algorithm_folder_path = '/net/people/plgrid/plgkogel/scratch/results/alexnet/Contribution_2h_007'
