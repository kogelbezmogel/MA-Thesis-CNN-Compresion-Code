...
if __name__ == '__main__':
    ...
    images_samples_path = os.path.join(config.BASE_PATH, f'datas/thinetsamples/cifar10_{samples_per_class}')
    ...
    algorithm_folder_path = os.path.join(config.BASE_PATH, 'results/resnet/FastThiNet_w_mini_4e')
    ...
    for ratio in ratios:
        ...
        for attempt in attempts:
            ...
            attempt_model_path = os.path.join(ratio_path, f'RN_at{attempt}')
            attempt_history_path = os.path.join(ratio_path, f'RN_at{attempt}_history.pickle')
