...
if __name__ == '__main__':
    ...
    hierarchical_groups = ls.get_hierarchical_groups_4h_resnet50_global_no_static()
    static_group = []

    attempts = [ i for i in range(0, 1) ]
    goal_flops_ratios = [0.87, 0.75, 0.64, 0.54, 0.45, 0.36, 0.29, 0.22]
    step_reduction_ratio = 0.07 # coresponds with 756 from MeanGradietn
    ...
    algorithm_folder_path = '/net/people/plgrid/plgkogel/scratch/results/resnet/Contribution_1h_007'
