...
if __name__ == '__main__':
    ...
    hierarchical_groups = ls.get_hierarchical_groups_3h_googlenet_experimental()
    ...
    algorithm_folder_path = '/net/people/plgrid/plgkogel/scratch/results/googlenet/MeanGradient_3h_exp'
