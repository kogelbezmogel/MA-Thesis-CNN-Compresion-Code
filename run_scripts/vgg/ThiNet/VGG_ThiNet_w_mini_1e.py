...
if __name__ == '__main__':
    ...
    ratios = [ round(val/10, 1) for val in range(1, 2) ]
    retrain_epochs = 1# in normal use should be 5 for prune and 3 for sensitivity analysis
    last_retrain_epochs = 10 # in normal use shold be 15
    minimize_err = True
    minimize_mode = 'colective'
    locations_per_image = 10
    algorithm_folder_path = f'/net/people/plgrid/plgkogel/scratch/results/vgg/ThiNet_w_mini_1e'
